...
/*Übung 5 - Strings in Variablen*/
console.log('Übung 5 - Strings in Variablen');
let meinName = 'Katharina';
let meineLieblingsFarbe = 'Pink';
let meinLieblingsEssen = 'Mochi';

console.log(`Mein Name ist ${meinName}, meine Lieblingsfarbe ist ${meineLieblingsFarbe} und mein Lieblingsessen ist ${meinLieblingsEssen}`);
console.log('..........');




/*Übung 6 - Zitate in Strings*/
console.log('Übung 6 - Zitate in Strings');
console.log('Meine Freundin heißt "Nina".');
console.log("Meine Freundin heißt \"Nina\".");
console.log('..........');
...
/*Übung 8 - Konkatenation von Strings*/
console.log('Übung 8 - Konkatenation von Strings');

let vorname = 'Katharina';
let alter = '36';
let lieblingsFilm = `Herr Der Ringe`;

console.log(`Mein Name ist ${vorname}, ich bin ${alter} Jahre alt und mein Lieblingsfilm ist ${lieblingsFilm}`);
